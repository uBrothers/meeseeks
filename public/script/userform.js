...
if(document.querySelector("#create_user")){
  document.querySelector("#create_user input[type='button']").onclick = function(e){
    ...
    if(document.querySelector("#email").value.indexOf("@") == -1){
      isValid = false;
      document.querySelector("#email_error").innerText = "- Correct email form is required.";
    }
    ...
    if(document.querySelector("#email").value !== document.querySelector("#email_confirmation").value){
      isValid = false;
      document.querySelector("#email_confirmation_error").innerText = "- Confirmation doesn't match with Email.";
    }
